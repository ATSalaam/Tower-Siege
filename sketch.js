...
function setup() {
  ...
  stand3 = new Stand(390,100,100,10);

  polygon = Bodies.circle(50,200,25);
  ...
  //Top platform
  block17 = new Block(390,75,50,60);
  ...
  block25 = new Block(740,135,30,40);

  //Side platform 1-3
  block26 = new Block(700,95,60,50);
